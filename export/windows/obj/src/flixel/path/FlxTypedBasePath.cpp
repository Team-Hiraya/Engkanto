...
HX_LOCAL_STACK_FRAME(_hx_pos_55e64b3c9045493d_301_draw,"flixel.path.FlxTypedBasePath","draw",0xbc1d228d,"flixel.path.FlxTypedBasePath.draw","flixel/path/FlxBasePath.hx",301,0xefb220ed)
HX_LOCAL_STACK_FRAME(_hx_pos_55e64b3c9045493d_320_drawDebugOnCamera,"flixel.path.FlxTypedBasePath","drawDebugOnCamera",0x732e2fca,"flixel.path.FlxTypedBasePath.drawDebugOnCamera","flixel/path/FlxBasePath.hx",320,0xefb220ed)
HX_LOCAL_STACK_FRAME(_hx_pos_55e64b3c9045493d_380_copyWorldToScreenPos,"flixel.path.FlxTypedBasePath","copyWorldToScreenPos",0x473781b9,"flixel.path.FlxTypedBasePath.copyWorldToScreenPos","flixel/path/FlxBasePath.hx",380,0xefb220ed)
HX_LOCAL_STACK_FRAME(_hx_pos_55e64b3c9045493d_400_drawNode,"flixel.path.FlxTypedBasePath","drawNode",0x91b9232f,"flixel.path.FlxTypedBasePath.drawNode","flixel/path/FlxBasePath.hx",400,0xefb220ed)
HX_LOCAL_STACK_FRAME(_hx_pos_55e64b3c9045493d_409_drawLine,"flixel.path.FlxTypedBasePath","drawLine",0x90623121,"flixel.path.FlxTypedBasePath.drawLine","flixel/path/FlxBasePath.hx",409,0xefb220ed)
namespace flixel{
namespace path{
...
HXLINE( 295)		this->ignoreDrawDebug = false;
HXLINE( 289)		this->debugDrawData =  ::flixel::path::FlxPathDrawData_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null());
...
void FlxTypedBasePath_obj::draw(){
            	HX_STACKFRAME(&_hx_pos_55e64b3c9045493d_301_draw)
HXDLIN( 301)		bool _hx_tmp;
HXDLIN( 301)		if (::flixel::FlxG_obj::debugger->drawDebug) {
HXDLIN( 301)			_hx_tmp = !(this->ignoreDrawDebug);
            		}
            		else {
HXDLIN( 301)			_hx_tmp = false;
            		}
HXDLIN( 301)		if (_hx_tmp) {
HXLINE( 303)			::flixel::FlxBasic_obj::visibleCount++;
HXLINE( 305)			{
HXLINE( 305)				int _g = 0;
HXDLIN( 305)				::Array< ::Dynamic> _g1 = this->getCameras();
HXDLIN( 305)				while((_g < _g1->length)){
HXLINE( 305)					 ::flixel::FlxCamera camera = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
HXDLIN( 305)					_g = (_g + 1);
HXLINE( 307)					this->drawDebugOnCamera(camera);
            				}
            			}
            		}
            	}
...
void FlxTypedBasePath_obj::drawDebugOnCamera( ::flixel::FlxCamera camera){
            	HX_STACKFRAME(&_hx_pos_55e64b3c9045493d_320_drawDebugOnCamera)
HXLINE( 322)		 ::openfl::display::Graphics gfx = null();
HXLINE( 323)		if (::flixel::FlxG_obj::renderBlit) {
HXLINE( 325)			gfx = ::flixel::util::FlxSpriteUtil_obj::flashGfx;
HXLINE( 326)			gfx->clear();
            		}
            		else {
HXLINE( 330)			gfx = camera->debugLayer->get_graphics();
            		}
HXLINE( 333)		int length = this->nodes->length;
HXLINE( 335)		{
HXLINE( 335)			int _g_current = 0;
HXDLIN( 335)			::Array< ::Dynamic> _g_array = this->nodes;
HXDLIN( 335)			while((_g_current < _g_array->length)){
HXLINE( 335)				 ::flixel::math::FlxBasePoint _g_value = _g_array->__get(_g_current).StaticCast<  ::flixel::math::FlxBasePoint >();
HXDLIN( 335)				_g_current = (_g_current + 1);
HXDLIN( 335)				int _g_key = (_g_current - 1);
HXDLIN( 335)				int i = _g_key;
HXDLIN( 335)				 ::flixel::math::FlxBasePoint node = _g_value;
HXLINE( 336)				{
HXLINE( 338)					 ::flixel::math::FlxBasePoint prevNodeScreen = this->copyWorldToScreenPos(node,camera,null());
HXLINE( 341)					int nodeSize = this->debugDrawData->nodeSize;
HXLINE( 342)					int nodeColor = this->debugDrawData->nodeColor;
HXLINE( 343)					if ((length > 1)) {
HXLINE( 345)						if ((i == 0)) {
HXLINE( 347)							nodeColor = this->debugDrawData->startColor;
HXLINE( 348)							nodeSize = this->debugDrawData->startSize;
            						}
            						else {
HXLINE( 350)							if ((i == (length - 1))) {
HXLINE( 352)								nodeColor = this->debugDrawData->endColor;
HXLINE( 353)								nodeSize = this->debugDrawData->endSize;
            							}
            						}
            					}
HXLINE( 358)					{
HXLINE( 358)						gfx->beginFill((nodeColor & 16777215),(( (Float)(((nodeColor >> 24) & 255)) ) / ( (Float)(255) )));
HXDLIN( 358)						gfx->lineStyle(null(),null(),null(),null(),null(),null(),null(),null());
HXDLIN( 358)						int offset = ::Math_obj::floor((( (Float)(nodeSize) ) * ((Float)0.5)));
HXDLIN( 358)						gfx->drawRect((prevNodeScreen->x - ( (Float)(offset) )),(prevNodeScreen->y - ( (Float)(offset) )),( (Float)(nodeSize) ),( (Float)(nodeSize) ));
HXDLIN( 358)						gfx->endFill();
            					}
HXLINE( 360)					bool _hx_tmp;
HXDLIN( 360)					if (((i + 1) >= length)) {
HXLINE( 360)						_hx_tmp = (this->loopType == 16);
            					}
            					else {
HXLINE( 360)						_hx_tmp = true;
            					}
HXDLIN( 360)					if (_hx_tmp) {
HXLINE( 363)						 ::flixel::math::FlxBasePoint nextNode = this->nodes->__get(::hx::Mod((i + 1),length)).StaticCast<  ::flixel::math::FlxBasePoint >();
HXLINE( 364)						 ::flixel::math::FlxBasePoint nextNodeScreen = this->copyWorldToScreenPos(nextNode,camera,null());
HXLINE( 365)						this->drawLine(gfx,prevNodeScreen,nextNodeScreen);
HXLINE( 366)						nextNodeScreen->put();
            					}
HXLINE( 368)					prevNodeScreen->put();
            				}
            			}
            		}
HXLINE( 371)		if (::flixel::FlxG_obj::renderBlit) {
HXLINE( 374)			camera->buffer->draw(::flixel::util::FlxSpriteUtil_obj::flashGfxSprite,null(),null(),null(),null(),null());
            		}
            	}


HX_DEFINE_DYNAMIC_FUNC1(FlxTypedBasePath_obj,drawDebugOnCamera,(void))

 ::flixel::math::FlxBasePoint FlxTypedBasePath_obj::copyWorldToScreenPos( ::flixel::math::FlxBasePoint point, ::flixel::FlxCamera camera, ::flixel::math::FlxBasePoint result){
            	HX_STACKFRAME(&_hx_pos_55e64b3c9045493d_380_copyWorldToScreenPos)
HXLINE( 381)		 ::flixel::math::FlxBasePoint p = result;
HXDLIN( 381)		if (::hx::IsNull( p )) {
...
HXDLIN( 381)		result = p->set(point->x,point->y);
HXLINE( 382)		if (::Std_obj::isOfType(this->target,::hx::ClassOf< ::flixel::FlxObject >())) {
HXLINE( 384)			 ::flixel::FlxObject object = ( ( ::flixel::FlxObject)(this->target) );
HXLINE( 385)			result->set_x((result->x - (camera->scroll->x * object->scrollFactor->x)));
HXLINE( 386)			result->set_y((result->y - (camera->scroll->y * object->scrollFactor->y)));
            		}
HXLINE( 389)		if (::flixel::FlxG_obj::renderBlit) {
HXLINE( 391)			result->set_x((result->x - camera->viewMarginX));
HXLINE( 392)			result->set_y((result->y - camera->viewMarginY));
            		}
HXLINE( 395)		camera->transformPoint(result);
HXLINE( 396)		return result;
            	}


HX_DEFINE_DYNAMIC_FUNC3(FlxTypedBasePath_obj,copyWorldToScreenPos,return )

void FlxTypedBasePath_obj::drawNode( ::openfl::display::Graphics gfx, ::flixel::math::FlxBasePoint node,int size,int color){
            	HX_STACKFRAME(&_hx_pos_55e64b3c9045493d_400_drawNode)
HXLINE( 401)		gfx->beginFill((color & 16777215),(( (Float)(((color >> 24) & 255)) ) / ( (Float)(255) )));
HXLINE( 402)		gfx->lineStyle(null(),null(),null(),null(),null(),null(),null(),null());
HXLINE( 403)		int offset = ::Math_obj::floor((( (Float)(size) ) * ((Float)0.5)));
HXLINE( 404)		gfx->drawRect((node->x - ( (Float)(offset) )),(node->y - ( (Float)(offset) )),( (Float)(size) ),( (Float)(size) ));
HXLINE( 405)		gfx->endFill();
            	}


HX_DEFINE_DYNAMIC_FUNC4(FlxTypedBasePath_obj,drawNode,(void))

void FlxTypedBasePath_obj::drawLine( ::openfl::display::Graphics gfx, ::flixel::math::FlxBasePoint node1, ::flixel::math::FlxBasePoint node2){
            	HX_STACKFRAME(&_hx_pos_55e64b3c9045493d_409_drawLine)
HXLINE( 411)		int color = this->debugDrawData->lineColor;
HXLINE( 412)		int size = this->debugDrawData->lineSize;
HXLINE( 413)		gfx->lineStyle(size,(color & 16777215),(( (Float)(((color >> 24) & 255)) ) / ( (Float)(255) )),null(),null(),null(),null(),null());
HXLINE( 415)		Float lineOffset = (( (Float)(this->debugDrawData->lineSize) ) / ( (Float)(2) ));
HXLINE( 416)		gfx->moveTo((node1->x + lineOffset),(node1->y + lineOffset));
HXLINE( 417)		gfx->lineTo((node2->x + lineOffset),(node2->y + lineOffset));
            	}


HX_DEFINE_DYNAMIC_FUNC3(FlxTypedBasePath_obj,drawLine,(void))
...
::hx::Val FlxTypedBasePath_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 8:
		...
		if (HX_FIELD_EQ(inName,"drawNode") ) { return ::hx::Val( drawNode_dyn() ); }
	...
	case 17:
		...
		break;
	case 20:
		if (HX_FIELD_EQ(inName,"copyWorldToScreenPos") ) { return ::hx::Val( copyWorldToScreenPos_dyn() ); }
	}
...
static ::hx::StorageInfo FlxTypedBasePath_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsObject /*  ::flixel::path::FlxPathDrawData */ ,(int)offsetof(FlxTypedBasePath_obj,debugDrawData),HX_("debugDrawData",c1,19,85,76)},
	{::hx::fsBool,(int)offsetof(FlxTypedBasePath_obj,ignoreDrawDebug),HX_("ignoreDrawDebug",3d,fc,11,6b)},
	{ ::hx::fsUnknown, 0, null()}
};
...
static ::String FlxTypedBasePath_obj_sMemberFields[] = {
	...
	HX_("copyWorldToScreenPos",30,29,43,55),
	HX_("drawNode",26,b4,73,5d),

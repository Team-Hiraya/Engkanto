...
HX_DEFINE_STACK_FRAME(_hx_pos_d2197318fd890c91_535_new,"flixel.path.FlxTypedPathfinderData","new",0xf7913c76,"flixel.path.FlxTypedPathfinderData.new","flixel/path/FlxPathfinder.hx",535,0x74454158)
HX_LOCAL_STACK_FRAME(_hx_pos_d2197318fd890c91_589_getPathIndicesTo,"flixel.path.FlxTypedPathfinderData","getPathIndicesTo",0xf3c26dd1,"flixel.path.FlxTypedPathfinderData.getPathIndicesTo","flixel/path/FlxPathfinder.hx",589,0x74454158)
HX_LOCAL_STACK_FRAME(_hx_pos_d2197318fd890c91_617_getPathIndices,"flixel.path.FlxTypedPathfinderData","getPathIndices",0x38418ab6,"flixel.path.FlxTypedPathfinderData.getPathIndices","flixel/path/FlxPathfinder.hx",617,0x74454158)
HX_LOCAL_STACK_FRAME(_hx_pos_d2197318fd890c91_622_hasValidStartEnd,"flixel.path.FlxTypedPathfinderData","hasValidStartEnd",0x4a9b7c25,"flixel.path.FlxTypedPathfinderData.hasValidStartEnd","flixel/path/FlxPathfinder.hx",622,0x74454158)
...
void FlxTypedPathfinderData_obj::__construct( ::Dynamic map,int startIndex,int endIndex){
            	HX_STACKFRAME(&_hx_pos_d2197318fd890c91_535_new)
HXLINE( 559)		this->numChecks = 0;
HXLINE( 572)		this->map = map;
HXLINE( 573)		::Array< int > _g = ::Array_obj< int >::__new(0);
HXDLIN( 573)		{
HXLINE( 573)			int _g1 = 0;
HXDLIN( 573)			int _g2 = ( ( ::flixel::tile::FlxBaseTilemap)(map) )->totalTiles;
HXDLIN( 573)			while((_g1 < _g2)){
HXLINE( 573)				_g1 = (_g1 + 1);
HXDLIN( 573)				int i = (_g1 - 1);
HXDLIN( 573)				_g->push(-1);
            			}
            		}
HXDLIN( 573)		this->distances = _g;
HXLINE( 574)		this->distances[startIndex] = 0;
HXLINE( 576)		::Array< int > _g3 = ::Array_obj< int >::__new(0);
HXDLIN( 576)		{
HXLINE( 576)			int _g4 = 0;
HXDLIN( 576)			int _g5 = ( ( ::flixel::tile::FlxBaseTilemap)(map) )->totalTiles;
HXDLIN( 576)			while((_g4 < _g5)){
HXLINE( 576)				_g4 = (_g4 + 1);
HXDLIN( 576)				int i1 = (_g4 - 1);
HXDLIN( 576)				_g3->push(-1);
            			}
            		}
HXDLIN( 576)		this->moves = _g3;
HXLINE( 578)		this->excluded = ::Array_obj< int >::__new(1)->init(0,startIndex);
HXLINE( 580)		this->startIndex = startIndex;
HXLINE( 581)		this->endIndex = endIndex;
            	}
...
::Array< int > FlxTypedPathfinderData_obj::getPathIndicesTo(int index){
            	HX_STACKFRAME(&_hx_pos_d2197318fd890c91_589_getPathIndicesTo)
HXLINE( 590)		if ((index == this->startIndex)) {
HXLINE( 591)			return ::Array_obj< int >::__new(2)->init(0,this->startIndex)->init(1,index);
            		}
HXLINE( 593)		if ((this->moves->__get(index) == -1)) {
HXLINE( 594)			return null();
            		}
HXLINE( 596)		::Array< int > path = ::Array_obj< int >::__new();
HXLINE( 599)		while((index != -1)){
HXLINE( 601)			path->unshift(index);
HXLINE( 602)			index = this->moves->__get(index);
            		}
HXLINE( 605)		if ((path->__get(0) != this->startIndex)) {
HXLINE( 606)			::flixel::FlxG_obj::log->advanced(HX_("getPathIndices ended up somewhere other than the start",7c,aa,6e,b9),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true,::hx::SourceInfo(HX_("flixel/path/FlxPathfinder.hx",58,41,45,74),606,HX_("flixel.path.FlxTypedPathfinderData",84,89,78,56),HX_("getPathIndicesTo",a7,2f,0e,93)));
            		}
HXLINE( 608)		return path;
            	}
...
::Array< int > FlxTypedPathfinderData_obj::getPathIndices(){
            	HX_STACKFRAME(&_hx_pos_d2197318fd890c91_617_getPathIndices)
HXDLIN( 617)		return this->getPathIndicesTo(this->endIndex);
            	}
...
bool FlxTypedPathfinderData_obj::hasValidStartEnd(){
            	HX_STACKFRAME(&_hx_pos_d2197318fd890c91_622_hasValidStartEnd)
HXDLIN( 622)		int mapIndex = this->startIndex;
HXDLIN( 622)		bool _hx_tmp;
HXDLIN( 622)		if ((mapIndex >= 0)) {
HXDLIN( 622)			_hx_tmp = (mapIndex < ( ( ::flixel::tile::FlxBaseTilemap)(this->map) )->_data->length);
            		}
            		else {
HXDLIN( 622)			_hx_tmp = false;
            		}
HXDLIN( 622)		if (_hx_tmp) {
HXLINE( 623)			int mapIndex1 = this->endIndex;
HXDLIN( 623)			if ((mapIndex1 >= 0)) {
HXLINE( 623)				return (mapIndex1 < ( ( ::flixel::tile::FlxBaseTilemap)(this->map) )->_data->length);
            			}
            			else {
...
HXLINE( 667)		 ::Dynamic _this = this->map;
HXDLIN( 667)		int _hx_tmp;
HXDLIN( 667)		bool _hx_tmp1;
HXDLIN( 667)		if ((tile >= 0)) {
HXLINE( 667)			_hx_tmp1 = (tile < ( ( ::flixel::tile::FlxBaseTilemap)(_this) )->_data->length);
            		}
            		else {
HXLINE( 667)			_hx_tmp1 = false;
            		}
HXDLIN( 667)		if (_hx_tmp1) {
HXLINE( 667)			_hx_tmp = ( ( ::flixel::tile::FlxBaseTilemap)(_this) )->_data->__get(tile);
            		}
            		else {
HXLINE( 667)			_hx_tmp = -1;
            		}
HXDLIN( 667)		return Dynamic( ( ( ::flixel::tile::FlxBaseTilemap)(_this) )->_tileObjects->__get(_hx_tmp)).StaticCast<  ::flixel::FlxObject >()->allowCollisions;
            	}

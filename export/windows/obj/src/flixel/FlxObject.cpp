...
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1271_drawDebugBoundingBox,"flixel.FlxObject","drawDebugBoundingBox",0xa96b1247,"flixel.FlxObject.drawDebugBoundingBox","flixel/FlxObject.hx",1271,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1278_getDebugBoundingBoxColor,"flixel.FlxObject","getDebugBoundingBoxColor",0xc0f2db08,"flixel.FlxObject.getDebugBoundingBoxColor","flixel/FlxObject.hx",1278,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1293_drawDebugBoundingBoxColor,"flixel.FlxObject","drawDebugBoundingBoxColor",0x00142d9c,"flixel.FlxObject.drawDebugBoundingBoxColor","flixel/FlxObject.hx",1293,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1301_beginDrawDebug,"flixel.FlxObject","beginDrawDebug",0x8677cfb5,"flixel.FlxObject.beginDrawDebug","flixel/FlxObject.hx",1301,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1314_endDrawDebug,"flixel.FlxObject","endDrawDebug",0x2518e603,"flixel.FlxObject.endDrawDebug","flixel/FlxObject.hx",1314,0xf0fe0d80)
...
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1382_set_width,"flixel.FlxObject","set_width",0x7d06d55a,"flixel.FlxObject.set_width","flixel/FlxObject.hx",1382,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1396_set_height,"flixel.FlxObject","set_height",0x9f435213,"flixel.FlxObject.set_height","flixel/FlxObject.hx",1396,0xf0fe0d80)
...
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1467_set_debugBoundingBoxColorSolid,"flixel.FlxObject","set_debugBoundingBoxColorSolid",0xb8a23688,"flixel.FlxObject.set_debugBoundingBoxColorSolid","flixel/FlxObject.hx",1467,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1473_set_debugBoundingBoxColorNotSolid,"flixel.FlxObject","set_debugBoundingBoxColorNotSolid",0x55ae1bdb,"flixel.FlxObject.set_debugBoundingBoxColorNotSolid","flixel/FlxObject.hx",1473,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1479_set_debugBoundingBoxColorPartial,"flixel.FlxObject","set_debugBoundingBoxColorPartial",0x34746b1e,"flixel.FlxObject.set_debugBoundingBoxColorPartial","flixel/FlxObject.hx",1479,0xf0fe0d80)
...
HXLINE(1250)		if (::flixel::FlxG_obj::renderTile) {
HXLINE(1252)			int PAD = 2;
HXLINE(1253)			 ::flixel::math::FlxRect view = camera->getViewMarginRect(null());
HXLINE(1254)			{
HXLINE(1254)				Float Value = (view->x - ( (Float)(PAD) ));
HXDLIN(1254)				 ::flixel::math::FlxRect view1 = view;
HXDLIN(1254)				view1->width = (view1->width - (Value - view->x));
HXDLIN(1254)				view->x = Value;
            			}
HXLINE(1255)			{
HXLINE(1255)				Float Value1 = (view->y - ( (Float)(PAD) ));
HXDLIN(1255)				 ::flixel::math::FlxRect view2 = view;
HXDLIN(1255)				view2->height = (view2->height - (Value1 - view->y));
HXDLIN(1255)				view->y = Value1;
            			}
HXLINE(1256)			{
HXLINE(1256)				Float Value2 = ((view->x + view->width) + PAD);
HXDLIN(1256)				view->width = (Value2 - view->x);
            			}
HXLINE(1257)			{
HXLINE(1257)				Float Value3 = ((view->y + view->height) + PAD);
HXDLIN(1257)				view->height = (Value3 - view->y);
            			}
HXLINE(1258)			rect->clipTo(view);
HXLINE(1259)			if (!(view->_inPool)) {
HXLINE(1259)				view->_inPool = true;
HXDLIN(1259)				view->_weak = false;
HXDLIN(1259)				::flixel::math::FlxRect_obj::_pool->putUnsafe(view);
            			}
            		}
HXLINE(1262)		bool _hx_tmp2;
HXDLIN(1262)		if ((rect->width > 0)) {
HXLINE(1262)			_hx_tmp2 = (rect->height > 0);
            		}
            		else {
HXLINE(1262)			_hx_tmp2 = false;
            		}
HXDLIN(1262)		if (_hx_tmp2) {
HXLINE(1264)			 ::openfl::display::Graphics gfx;
HXDLIN(1264)			if (::flixel::FlxG_obj::renderBlit) {
HXLINE(1264)				::flixel::util::FlxSpriteUtil_obj::flashGfx->clear();
HXDLIN(1264)				gfx = ::flixel::util::FlxSpriteUtil_obj::flashGfx;
            			}
            			else {
HXLINE(1264)				gfx = camera->debugLayer->get_graphics();
            			}
HXLINE(1265)			this->drawDebugBoundingBox(gfx,rect,this->allowCollisions,this->immovable);
HXLINE(1266)			if (::flixel::FlxG_obj::renderBlit) {
HXLINE(1266)				camera->buffer->draw(::flixel::util::FlxSpriteUtil_obj::flashGfxSprite,null(),null(),null(),null(),null());
            			}
            		}
            	}
...
void FlxObject_obj::drawDebugBoundingBox( ::openfl::display::Graphics gfx, ::flixel::math::FlxRect rect,int allowCollisions,bool partial){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1271_drawDebugBoundingBox)
HXLINE(1273)		 ::Dynamic color = this->getDebugBoundingBoxColor(allowCollisions);
HXLINE(1274)		this->drawDebugBoundingBoxColor(gfx,rect,( (int)(color) ));
            	}
...
HX_DEFINE_DYNAMIC_FUNC4(FlxObject_obj,drawDebugBoundingBox,(void))
 ...
 ::Dynamic FlxObject_obj::getDebugBoundingBoxColor(int allowCollisions){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1278_getDebugBoundingBoxColor)
HXLINE(1279)		if (::hx::IsNotNull( this->debugBoundingBoxColor )) {
HXLINE(1280)			return this->debugBoundingBoxColor;
            		}
HXLINE(1282)		if ((allowCollisions == 0)) {
HXLINE(1283)			return this->debugBoundingBoxColorNotSolid;
            		}
HXLINE(1285)		if ((allowCollisions == 4369)) {
HXLINE(1286)			return this->debugBoundingBoxColorSolid;
            		}
HXLINE(1288)		return this->debugBoundingBoxColorPartial;
            	}
...
void FlxObject_obj::drawDebugBoundingBoxColor( ::openfl::display::Graphics gfx, ::flixel::math::FlxRect rect,int color){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1293_drawDebugBoundingBoxColor)
HXLINE(1295)		gfx->lineStyle(1,color,((Float)0.75),false,null(),null(),1,255);
HXLINE(1296)		gfx->drawRect((rect->x + ((Float)0.5)),(rect->y + ((Float)0.5)),(rect->width - ((Float)1.0)),(rect->height - ((Float)1.0)));
            	}
...
HX_DEFINE_DYNAMIC_FUNC3(FlxObject_obj,drawDebugBoundingBoxColor,(void))
 ...
 ::openfl::display::Graphics FlxObject_obj::beginDrawDebug( ::flixel::FlxCamera camera){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1301_beginDrawDebug)
HXDLIN(1301)		if (::flixel::FlxG_obj::renderBlit) {
HXLINE(1303)			::flixel::util::FlxSpriteUtil_obj::flashGfx->clear();
HXLINE(1304)			return ::flixel::util::FlxSpriteUtil_obj::flashGfx;
            		}
            		else {
HXLINE(1308)			return camera->debugLayer->get_graphics();
            		}
...
void FlxObject_obj::endDrawDebug( ::flixel::FlxCamera camera){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1314_endDrawDebug)
HXDLIN(1314)		if (::flixel::FlxG_obj::renderBlit) {
HXLINE(1315)			camera->buffer->draw(::flixel::util::FlxSpriteUtil_obj::flashGfxSprite,null(),null(),null(),null(),null());
            		}
            	}
...
Float FlxObject_obj::set_width(Float value){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1382_set_width)
HXLINE(1384)		if ((value < 0)) {
HXLINE(1386)			::flixel::FlxG_obj::log->advanced(HX_("An object's width cannot be smaller than 0. Use offset for sprites to control the hitbox position!",f5,8d,0b,95),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true,::hx::SourceInfo(HX_("flixel/FlxObject.hx",80,0d,fe,f0),1386,HX_("flixel.FlxObject",1f,50,95,35),HX_("set_width",69,fe,5c,f1)));
HXLINE(1387)			return value;
            		}
HXLINE(1391)		return (this->width = value);
            	}
...
Float FlxObject_obj::set_height(Float value){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1396_set_height)
HXLINE(1398)		if ((value < 0)) {
HXLINE(1400)			::flixel::FlxG_obj::log->advanced(HX_("An object's height cannot be smaller than 0. Use offset for sprites to control the hitbox position!",b0,49,90,e4),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true,::hx::SourceInfo(HX_("flixel/FlxObject.hx",80,0d,fe,f0),1400,HX_("flixel.FlxObject",1f,50,95,35),HX_("set_height",24,16,51,f6)));
HXLINE(1401)			return value;
            		}
HXLINE(1405)		return (this->height = value);
            	}
...
int FlxObject_obj::set_debugBoundingBoxColorSolid(int color){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1467_set_debugBoundingBoxColorSolid)
HXDLIN(1467)		return (this->debugBoundingBoxColorSolid = color);
            	}
...
int FlxObject_obj::set_debugBoundingBoxColorNotSolid(int color){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1473_set_debugBoundingBoxColorNotSolid)
HXDLIN(1473)		return (this->debugBoundingBoxColorNotSolid = color);
            	}
...
int FlxObject_obj::set_debugBoundingBoxColorPartial(int color){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1479_set_debugBoundingBoxColorPartial)
HXDLIN(1479)		return (this->debugBoundingBoxColorPartial = color);
            	}

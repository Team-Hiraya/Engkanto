...
HXLINE( 448)				( ( ::flixel::math::FlxBasePoint)(( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("velocityRange",60,4a,a1,8e),::hx::paccDynamic)) )->start) )->set(this->_point->x,this->_point->y);
...
HXDLIN( 451)				 ::flixel::math::FlxBasePoint point2 = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x1,y1);
HXDLIN( 451)				point2->_inPool = false;
HXDLIN( 451)				this->_point = point2;
HXLINE( 452)				( ( ::flixel::math::FlxBasePoint)(( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("velocityRange",60,4a,a1,8e),::hx::paccDynamic)) )->end) )->set(this->_point->x,this->_point->y);
            			}
            			else {
HXLINE( 456)				{
...
HXLINE( 499)			{
HXLINE( 499)				 ::flixel::math::FlxBasePoint this5 = ( ( ::flixel::math::FlxBasePoint)(( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("scaleRange",d3,52,53,05),::hx::paccDynamic)) )->start) );
HXDLIN( 499)				this5->set_x(::flixel::FlxG_obj::random->_hx_float(( ( ::flixel::math::FlxBasePoint)(this->scale->start->min) )->x,( ( ::flixel::math::FlxBasePoint)(this->scale->start->max) )->x,null()));
            			}
HXLINE( 500)			{
HXLINE( 500)				 ::flixel::math::FlxBasePoint this6 = ( ( ::flixel::math::FlxBasePoint)(( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("scaleRange",d3,52,53,05),::hx::paccDynamic)) )->start) );
HXDLIN( 500)				Float y2;
HXDLIN( 500)				if (this->keepScaleRatio) {
HXLINE( 500)					y2 = ( ( ::flixel::math::FlxBasePoint)(( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("scaleRange",d3,52,53,05),::hx::paccDynamic)) )->start) )->x;
            				}
            				else {
HXLINE( 500)					y2 = ::flixel::FlxG_obj::random->_hx_float(( ( ::flixel::math::FlxBasePoint)(this->scale->start->min) )->y,( ( ::flixel::math::FlxBasePoint)(this->scale->start->max) )->y,null());
            				}
HXDLIN( 500)				this6->set_y(y2);
            			}
HXLINE( 501)			{
HXLINE( 501)				 ::flixel::math::FlxBasePoint this7 = ( ( ::flixel::math::FlxBasePoint)(( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("scaleRange",d3,52,53,05),::hx::paccDynamic)) )->end) );
HXDLIN( 501)				this7->set_x(::flixel::FlxG_obj::random->_hx_float(( ( ::flixel::math::FlxBasePoint)(this->scale->end->min) )->x,( ( ::flixel::math::FlxBasePoint)(this->scale->end->max) )->x,null()));
            			}
HXLINE( 502)			{
HXLINE( 502)				 ::flixel::math::FlxBasePoint this8 = ( ( ::flixel::math::FlxBasePoint)(( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("scaleRange",d3,52,53,05),::hx::paccDynamic)) )->end) );
HXDLIN( 502)				Float y3;
HXDLIN( 502)				if (this->keepScaleRatio) {
HXLINE( 502)					y3 = ( ( ::flixel::math::FlxBasePoint)(( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("scaleRange",d3,52,53,05),::hx::paccDynamic)) )->end) )->x;
            				}
            				else {
HXLINE( 502)					y3 = ::flixel::FlxG_obj::random->_hx_float(( ( ::flixel::math::FlxBasePoint)(this->scale->end->min) )->y,( ( ::flixel::math::FlxBasePoint)(this->scale->end->max) )->y,null());
            				}
HXDLIN( 502)				this8->set_y(y3);
            			}
...
HXLINE( 537)			{
HXLINE( 537)				 ::flixel::math::FlxBasePoint this9 = ( ( ::flixel::math::FlxBasePoint)(( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("dragRange",29,15,75,46),::hx::paccDynamic)) )->start) );
HXDLIN( 537)				this9->set_x(::flixel::FlxG_obj::random->_hx_float(( ( ::flixel::math::FlxBasePoint)(this->drag->start->min) )->x,( ( ::flixel::math::FlxBasePoint)(this->drag->start->max) )->x,null()));
            			}
HXLINE( 538)			{
HXLINE( 538)				 ::flixel::math::FlxBasePoint this10 = ( ( ::flixel::math::FlxBasePoint)(( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("dragRange",29,15,75,46),::hx::paccDynamic)) )->start) );
HXDLIN( 538)				this10->set_y(::flixel::FlxG_obj::random->_hx_float(( ( ::flixel::math::FlxBasePoint)(this->drag->start->min) )->y,( ( ::flixel::math::FlxBasePoint)(this->drag->start->max) )->y,null()));
            			}
HXLINE( 539)			{
HXLINE( 539)				 ::flixel::math::FlxBasePoint this11 = ( ( ::flixel::math::FlxBasePoint)(( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("dragRange",29,15,75,46),::hx::paccDynamic)) )->end) );
HXDLIN( 539)				this11->set_x(::flixel::FlxG_obj::random->_hx_float(( ( ::flixel::math::FlxBasePoint)(this->drag->end->min) )->x,( ( ::flixel::math::FlxBasePoint)(this->drag->end->max) )->x,null()));
            			}
HXLINE( 540)			{
HXLINE( 540)				 ::flixel::math::FlxBasePoint this12 = ( ( ::flixel::math::FlxBasePoint)(( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("dragRange",29,15,75,46),::hx::paccDynamic)) )->end) );
HXDLIN( 540)				this12->set_y(::flixel::FlxG_obj::random->_hx_float(( ( ::flixel::math::FlxBasePoint)(this->drag->end->min) )->y,( ( ::flixel::math::FlxBasePoint)(this->drag->end->max) )->y,null()));
            			}
...
HXLINE( 551)			{
HXLINE( 551)				 ::flixel::math::FlxBasePoint this13 = ( ( ::flixel::math::FlxBasePoint)(( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("accelerationRange",5d,2d,23,34),::hx::paccDynamic)) )->start) );
HXDLIN( 551)				this13->set_x(::flixel::FlxG_obj::random->_hx_float(( ( ::flixel::math::FlxBasePoint)(this->acceleration->start->min) )->x,( ( ::flixel::math::FlxBasePoint)(this->acceleration->start->max) )->x,null()));
            			}
HXLINE( 552)			{
HXLINE( 552)				 ::flixel::math::FlxBasePoint this14 = ( ( ::flixel::math::FlxBasePoint)(( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("accelerationRange",5d,2d,23,34),::hx::paccDynamic)) )->start) );
HXDLIN( 552)				this14->set_y(::flixel::FlxG_obj::random->_hx_float(( ( ::flixel::math::FlxBasePoint)(this->acceleration->start->min) )->y,( ( ::flixel::math::FlxBasePoint)(this->acceleration->start->max) )->y,null()));
            			}
HXLINE( 553)			{
HXLINE( 553)				 ::flixel::math::FlxBasePoint this15 = ( ( ::flixel::math::FlxBasePoint)(( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("accelerationRange",5d,2d,23,34),::hx::paccDynamic)) )->end) );
HXDLIN( 553)				this15->set_x(::flixel::FlxG_obj::random->_hx_float(( ( ::flixel::math::FlxBasePoint)(this->acceleration->end->min) )->x,( ( ::flixel::math::FlxBasePoint)(this->acceleration->end->max) )->x,null()));
            			}
HXLINE( 554)			{
HXLINE( 554)				 ::flixel::math::FlxBasePoint this16 = ( ( ::flixel::math::FlxBasePoint)(( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("accelerationRange",5d,2d,23,34),::hx::paccDynamic)) )->end) );
HXDLIN( 554)				this16->set_y(::flixel::FlxG_obj::random->_hx_float(( ( ::flixel::math::FlxBasePoint)(this->acceleration->end->min) )->y,( ( ::flixel::math::FlxBasePoint)(this->acceleration->end->max) )->y,null()));
            			}

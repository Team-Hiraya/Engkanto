...
HXLINE( 374)		this->trackingInfo = HX_("",00,00,00,00);
...
void FlxGraphic_obj::__Mark(HX_MARK_PARAMS)
{
	...
	HX_MARK_MEMBER_NAME(trackingInfo,"trackingInfo");
	HX_MARK_END_CLASS();
}
...
void FlxGraphic_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	HX_VISIT_MEMBER_NAME(trackingInfo,"trackingInfo");
}
...
::hx::Val FlxGraphic_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 11:
		...
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"trackingInfo") ) { return ::hx::Val( trackingInfo ); }
...
::hx::Val FlxGraphic_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 11:
		...
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"trackingInfo") ) { trackingInfo=inValue.Cast< ::String >(); return inValue; }
		break;
	case 14:
...
void FlxGraphic_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_("trackingInfo",45,b3,db,0d));
...
static ::hx::StorageInfo FlxGraphic_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsString,(int)offsetof(FlxGraphic_obj,trackingInfo),HX_("trackingInfo",45,b3,db,0d)},
	{ ::hx::fsUnknown, 0, null()}
};

...
HXLINE(  96)		if ((newStr != str)) {
HXLINE(  97)			::flixel::FlxG_obj::log->advanced(((((((HX_("FlxSave ",91,54,66,34) + fieldId) + HX_(": \"",bc,1e,2c,00)) + str) + HX_("\" contains invalid characters, using \"",fc,4b,51,3a)) + newStr) + HX_("\" instead",84,0a,fc,b7)),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true,::hx::SourceInfo(HX_("flixel/util/FlxSave.hx",a9,d0,3c,c4),97,HX_("flixel.util.FlxSave",95,71,4e,bc),HX_("validateAndWarn",c7,76,d7,85)));
            		}

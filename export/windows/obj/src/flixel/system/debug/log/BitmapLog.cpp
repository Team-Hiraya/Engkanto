...
HXLINE( 168)		this->canvasOffset->set(( (Float)(0) ),( (Float)(0) ));
            	}
...
HXDLIN( 278)			point1->set((point1->x + point2->x),(point1->y + point2->y));
HXDLIN( 278)			{
...
HXDLIN( 303)			this->canvasOffset->set(( (Float)(0) ),( (Float)(0) ));
            		}

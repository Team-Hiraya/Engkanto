...
HX_LOCAL_STACK_FRAME(_hx_pos_6f944dca4f3bb528_176_set_visible,"flixel.system.frontEnds.DebuggerFrontEnd","set_visible",0xfdfb51d4,"flixel.system.frontEnds.DebuggerFrontEnd.set_visible","flixel/system/frontEnds/DebuggerFrontEnd.hx",176,0x2ebb4b30)
namespace flixel{
...
bool DebuggerFrontEnd_obj::set_visible(bool value){
            	HX_STACKFRAME(&_hx_pos_6f944dca4f3bb528_176_set_visible)
HXLINE( 177)		if ((this->visible == value)) {
HXLINE( 178)			return this->visible;
            		}
HXLINE( 180)		this->visible = value;
HXLINE( 183)		::flixel::FlxG_obj::game->debugger->set_visible(value);
HXLINE( 184)		::flixel::FlxG_obj::game->debugger->set_tabChildren(value);
HXLINE( 186)		this->visibilityChanged->dispatch();
HXLINE( 189)		return this->visible;
            	}

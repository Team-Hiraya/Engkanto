...
HX_DEFINE_STACK_FRAME(_hx_pos_3409faf9df01acb4_222_new,"flixel.system.frontEnds.DebugWindowsFrontEnd","new",0x76791b6e,"flixel.system.frontEnds.DebugWindowsFrontEnd.new","flixel/system/frontEnds/DebuggerFrontEnd.hx",222,0x2ebb4b30)
HX_LOCAL_STACK_FRAME(_hx_pos_3409faf9df01acb4_220_get_debugger,"flixel.system.frontEnds.DebugWindowsFrontEnd","get_debugger",0xb870bb5c,"flixel.system.frontEnds.DebugWindowsFrontEnd.get_debugger","flixel/system/frontEnds/DebuggerFrontEnd.hx",220,0x2ebb4b30)
HX_LOCAL_STACK_FRAME(_hx_pos_3409faf9df01acb4_225_add,"flixel.system.frontEnds.DebugWindowsFrontEnd","add",0x766f3d2f,"flixel.system.frontEnds.DebugWindowsFrontEnd.add","flixel/system/frontEnds/DebuggerFrontEnd.hx",225,0x2ebb4b30)
HX_LOCAL_STACK_FRAME(_hx_pos_3409faf9df01acb4_231_remove,"flixel.system.frontEnds.DebugWindowsFrontEnd","remove",0xcfc52df6,"flixel.system.frontEnds.DebugWindowsFrontEnd.remove","flixel/system/frontEnds/DebuggerFrontEnd.hx",231,0x2ebb4b30)
namespace flixel{
namespace _hx_system{
namespace frontEnds{

void DebugWindowsFrontEnd_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_3409faf9df01acb4_222_new)
            	}
...
bool DebugWindowsFrontEnd_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::flixel::_hx_system::debug::FlxDebugger DebugWindowsFrontEnd_obj::get_debugger(){
            	HX_STACKFRAME(&_hx_pos_3409faf9df01acb4_220_get_debugger)
HXDLIN( 220)		return ::flixel::FlxG_obj::game->debugger;
            	}
...
void DebugWindowsFrontEnd_obj::add( ::flixel::_hx_system::debug::Window window, ::Dynamic button){
            	HX_STACKFRAME(&_hx_pos_3409faf9df01acb4_225_add)
HXLINE( 226)		{
HXLINE( 226)			 ::flixel::_hx_system::debug::FlxDebugger _this = ::flixel::FlxG_obj::game->debugger;
HXDLIN( 226)			_this->_windows->push(window);
HXDLIN( 226)			_this->addChild(window);
HXDLIN( 226)			if (::hx::IsNotNull( _this->_screenBounds )) {
HXLINE( 226)				_this->updateBounds();
HXDLIN( 226)				window->bound();
            			}
            		}
HXLINE( 227)		::flixel::FlxG_obj::game->debugger->addWindowToggleButton(window,button);
            	}
...
void DebugWindowsFrontEnd_obj::remove( ::flixel::_hx_system::debug::Window window){
            	HX_STACKFRAME(&_hx_pos_3409faf9df01acb4_231_remove)
HXLINE( 232)		{
HXLINE( 232)			 ::flixel::_hx_system::debug::FlxDebugger _this = ::flixel::FlxG_obj::game->debugger;
HXDLIN( 232)			if (_this->contains(window)) {
HXLINE( 232)				_this->removeChild(window);
            			}
HXDLIN( 232)			{
HXLINE( 232)				::Array< ::Dynamic> array = _this->_windows;
HXDLIN( 232)				int index = array->indexOf(window,null());
HXDLIN( 232)				if ((index != -1)) {
HXLINE( 232)					array[index] = array->__get((array->length - 1)).StaticCast<  ::flixel::_hx_system::debug::Window >();
HXDLIN( 232)					array->pop().StaticCast<  ::flixel::_hx_system::debug::Window >();
            				}
            			}
            		}
HXLINE( 233)		if (::hx::IsNotNull( window->toggleButton )) {
HXLINE( 234)			::flixel::FlxG_obj::game->debugger->removeButton(window->toggleButton,null());
            		}
            	}

...
HX_LOCAL_STACK_FRAME(_hx_pos_790ec110ce1e7f7f_1115_loadGraphicFromSprite,"flixel.group.FlxTypedSpriteGroup","loadGraphicFromSprite",0x6f12dc84,"flixel.group.FlxTypedSpriteGroup.loadGraphicFromSprite","flixel/group/FlxSpriteGroup.hx",1115,0xeb1fa7f3)
...
HX_LOCAL_STACK_FRAME(_hx_pos_790ec110ce1e7f7f_1138_loadRotatedGraphic,"flixel.group.FlxTypedSpriteGroup","loadRotatedGraphic",0x45e23732,"flixel.group.FlxTypedSpriteGroup.loadRotatedGraphic","flixel/group/FlxSpriteGroup.hx",1138,0xeb1fa7f3)
HX_LOCAL_STACK_FRAME(_hx_pos_790ec110ce1e7f7f_1150_makeGraphic,"flixel.group.FlxTypedSpriteGroup","makeGraphic",0x27a1d44d,"flixel.group.FlxTypedSpriteGroup.makeGraphic","flixel/group/FlxSpriteGroup.hx",1150,0xeb1fa7f3)
...
HXLINE( 234)		this->group->draw();
HXLINE( 237)		if (::flixel::FlxG_obj::debugger->drawDebug) {
HXLINE( 238)			this->drawDebug();
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxTypedSpriteGroup_obj,scrollFactorCallback,(void))
 ...
 ::flixel::FlxSprite FlxTypedSpriteGroup_obj::loadGraphicFromSprite( ::flixel::FlxSprite Sprite){
            	HX_STACKFRAME(&_hx_pos_790ec110ce1e7f7f_1115_loadGraphicFromSprite)
HXDLIN(1115)		HX_STACK_DO_THROW(HX_("This function is not supported in FlxSpriteGroup",d4,53,54,91));
...
HXDLIN(1127)		return ::hx::ObjectPtr<OBJ_>(this);
 ...
 ::flixel::FlxSprite FlxTypedSpriteGroup_obj::loadRotatedGraphic( ::Dynamic Graphic,::hx::Null< int >  __o_Rotations,::hx::Null< int >  __o_Frame,::hx::Null< bool >  __o_AntiAliasing,::hx::Null< bool >  __o_AutoBuffer,::String Key){
            	...
            	HX_STACKFRAME(&_hx_pos_790ec110ce1e7f7f_1138_loadRotatedGraphic)
HXDLIN(1138)		HX_STACK_DO_THROW(HX_("This function is not supported in FlxSpriteGroup",d4,53,54,91));
HXDLIN(1138)		return null();
 ...
 ::flixel::FlxSprite FlxTypedSpriteGroup_obj::makeGraphic(int Width,int Height,::hx::Null< int >  __o__tmp_Color,::hx::Null< bool >  __o_Unique,::String Key){
            		...
            		bool Unique = __o_Unique.Default(false);
            	HX_STACKFRAME(&_hx_pos_790ec110ce1e7f7f_1150_makeGraphic)
HXDLIN(1150)		int Color = _tmp_Color;
HXDLIN(1150)		HX_STACK_DO_THROW(HX_("This function is not supported in FlxSpriteGroup",d4,53,54,91));

...
HXLINE(  78)			{
HXLINE(  78)				::haxe::IMap_obj::set(this->_hx___pool,object,false);
HXDLIN(  78)				if (::hx::IsNull( this->_hx___inactiveObject0 )) {
...
HXDLIN( 127)			::haxe::IMap_obj::set(this->_hx___pool,object1,true);
...
HXDLIN( 151)		if (::hx::IsNotNull( object )) {
HXLINE( 151)			_hx_tmp = !(::haxe::IMap_obj::exists(this->_hx___pool,object));
            		}
            		else {
HXLINE( 151)			_hx_tmp = true;
            		}
HXDLIN( 151)		if (_hx_tmp) {
HXLINE( 153)			::lime::utils::Log_obj::error(HX_("Object is not a member of the pool",0f,bf,52,70),::hx::SourceInfo(HX_("lime/utils/ObjectPool.hx",6b,d7,14,c1),153,HX_("lime.utils.ObjectPool",f1,2f,f4,28),HX_("release",c7,85,ed,58)));
            		}
            		else {
HXLINE( 155)			if (!(( (bool)(::haxe::IMap_obj::get(this->_hx___pool,object)) ))) {
HXLINE( 157)				::lime::utils::Log_obj::error(HX_("Object has already been released",22,4c,b8,02),::hx::SourceInfo(HX_("lime/utils/ObjectPool.hx",6b,d7,14,c1),157,HX_("lime.utils.ObjectPool",f1,2f,f4,28),HX_("release",c7,85,ed,58)));
            			}
            		}
HXLINE( 161)		this->activeObjects--;
HXLINE( 163)		bool _hx_tmp1;
HXDLIN( 163)		if (::hx::IsNotNull( this->_hx___size )) {
HXLINE( 163)			_hx_tmp1 = ::hx::IsLess( (this->activeObjects + this->inactiveObjects),this->_hx___size );
            		}
            		else {
...
HXLINE( 166)			{
HXLINE( 166)				::haxe::IMap_obj::set(this->_hx___pool,object,false);
HXDLIN( 166)				if (::hx::IsNull( this->_hx___inactiveObject0 )) {
...
HXLINE( 209)		::haxe::IMap_obj::set(this->_hx___pool,object,false);
...
HXLINE( 258)		::haxe::IMap_obj::set(this->_hx___pool,object,true);

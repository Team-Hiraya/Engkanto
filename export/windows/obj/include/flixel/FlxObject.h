...
class HXCPP_CLASS_ATTRIBUTES FlxObject_obj : public  ::flixel::FlxBasic_obj
{
	...
	public:
		...
		::Dynamic drawDebugBoundingBox_dyn();
		 ...
		 ::Dynamic getDebugBoundingBoxColor(int allowCollisions);
		::Dynamic getDebugBoundingBoxColor_dyn();

		void drawDebugBoundingBoxColor( ::openfl::display::Graphics gfx, ::flixel::math::FlxRect rect,int color);
		::Dynamic drawDebugBoundingBoxColor_dyn();

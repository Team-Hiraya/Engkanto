...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("engkanto", create);
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "77";
		app.meta["company"] = "Your Company";
		app.meta["file"] = "engkanto";
		app.meta["name"] = "Engkanto";
		app.meta["packageName"] = "com.yourname.engkanto";
